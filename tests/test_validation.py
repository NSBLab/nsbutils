import numpy as np
import pytest
from nsbutils.validation import (check_normalized_vectors,
                                 check_orthogonal_vectors,
                                 check_orthonormal_vectors, 
                                 check_orthogonal_matrix)
...
def test_check_orthogonal_matrix_typical():
    """Tests check_orthogonal_matrix() with a typical case.
    """
    ...
    assert check_orthogonal_matrix(vectors)

def test_check_orthogonal_matrix_non_orthogonal():
    """Tests check_orthogonal_matrix() with a non-orthogonal matrix.
    """
    ...
    assert not check_orthogonal_matrix(matrix)

def test_check_orthogonal_matrix_non_normalized():
    """Tests check_orthogonal_matrix() with a non-normalized matrix.
    """
